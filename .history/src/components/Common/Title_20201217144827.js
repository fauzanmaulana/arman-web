                    ...
                    {!searchMode 
                        ...
                        <div className="row mt-5 wow fadeInUp">
                            ...
                            {props.location.state && <div className="col-lg-2">
                                <h3 className="text-white m-0" data-wow-duration="1s" data-wow-delay=".1s">{props.location.state && <i className="fa fa-arrow-left" onClick={() => setSearchMode(!searchMode)} />} back</h3>
                            </div>}
                        </div>
                    }
                </div>
