                ...
                <div className="container">
                    {!searchMode 
                        ...
                        <div className="row mt-5 wow fadeInUp">
                            ...
                            {props.location.state && <div className="col-lg-2 d-flex align-items-center">
                                <h3 className="text-white" data-wow-duration="1s" data-wow-delay=".1s">{props.location.state && <i className="fa fa-arrow-left" onClick={() => setSearchMode(!searchMode)} />} back</h3>
                            </div>}
                        </div>
                    }
                </div>
