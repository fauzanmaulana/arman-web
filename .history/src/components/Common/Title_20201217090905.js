                    ...
                    {!searchMode 
                        ...
                        <div className="row mt-5">
                            ...
                            {props.location.state && <div className="col-lg-2">
                                <h3 className="wow fadeInUp text-white mt-5" data-wow-duration="1s" data-wow-delay=".1s">{props.location.state && <i className="fa fa-search" onClick={() => setSearchMode(!searchMode)} />}</h3>
                            </div>}
                        </div>
                    }
                </div>
